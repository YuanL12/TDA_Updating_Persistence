...
.def("dim", py::overload_cast<size_t>(&ChainComplex<MT>::dim, py::const_))\
...
.def("RC", [](ReducedFilteredChainComplex<T, MT>& C) {return C.RC;}, "reduced chain complex")\
...
.def("update_filtration_general", &ReducedFilteredChainComplex<T, MT>::update_filtration_general<Update_info<Filtration<T, SimplicialComplex>>>, "general update filtration with updating information")\
.def("update_filtration_general", &ReducedFilteredChainComplex<T, MT>::update_filtration_general<Update_info<Filtration<T, DefaultLightSimplicialComplex>>>, "general update filtration with updating information");
// .def("update_filtration_fast", [](ReducedFilteredChainComplex<T, MT>& F, Information_type& updating_information){return F.update_filtration_fast(updating_information); }, "general update filtration with updating information");
...
PYBIND11_MODULE(libbats, m) {
	...
	// m.def("rips_filtration_extension", &RipsFiltration_extension<bats::DataSet<double>, bats::Euclidean, double, size_t>, "Rips Filtration with inverse map returned");
	m.def("rips_filtration_extension", [](const bats::DataSet<double>& X, const bats::Euclidean &dist, double rmax,  size_t dmax) {return bats::RipsFiltration_extension<SimplicialComplex>(X, dist, rmax, dmax);}, "Rips Filtration with inverse map returned");
