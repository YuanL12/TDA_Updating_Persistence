...
# If you want to add more tests, then simple change paremeters like:
# number of points, dimension
# then, all resutls will be added into the noisy_circle_2D_3D_change_std.csv
...
need_header = True
import os.path
filename = 'noisy_circle_std_new.csv'
...
with open(filename, 'a', encoding='UTF8', newline='') as f:
    ...
    for sigma in np.logspace(-3, 3, num=40):
        for n in [100]:
            for d in [2]:
                # create dataset
                ...
                for i in range(n_repeats):
                    ...
                    record_line.extend(time_BATS_updates_enc_rips_record(X,Y,d))
